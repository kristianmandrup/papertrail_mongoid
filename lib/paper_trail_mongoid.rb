...
require 'paper_trail_mongoid/config'
require 'paper_trail_mongoid/controller'
require 'paper_trail_mongoid/has_paper_trail'
require 'paper_trail_mongoid/version'
require 'paper_trail_mongoid/mongoid/version_ext'
